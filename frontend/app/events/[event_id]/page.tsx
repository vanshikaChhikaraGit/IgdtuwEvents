    ...
    return (
      ...
      <div className="p-4">
        ...
        <h2 className="text-md m-2">{eventById?.event_description}</h2>
         ...
         <Button variant={"destructive"} className="bg-red-600 rounded-full hover:bg-transparent hover:border-2 hover:border-red-500"onClick={()=>{ window.location.href = eventById?.registration_link || " "}}>Register</Button>
